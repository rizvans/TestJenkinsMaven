...
public class TC3 extends Base
{
	...
	{		
		...
		List<WebElement>Subscriptions=driver.findElements(By.xpath("//yt-formatted-string[@class='title style-scope ytd-guide-entry-renderer']"));
		Subscriptions.get(2).click();
		Thread.sleep(4000);
